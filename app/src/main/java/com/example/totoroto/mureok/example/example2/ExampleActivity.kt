...
//        runByThread()
    ...
    private class ExampleTask(val list: MutableList<Int>, val tv: TextView): AsyncTask<Void, Void, List<Int>>() {
        val tvRef : WeakReference<TextView> = WeakReference(tv)
